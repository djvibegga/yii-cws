...
public:
    ...
    virtual _string renderFile(const string & viewFile, CDT & data, bool ret = false);
    virtual _string renderInternal(const string & viewFile, CDT & data, bool ret = false) const;
